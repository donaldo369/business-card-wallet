...
5. 한국 명함/서명에는 같은 정보가 한글과 영문으로 함께 표기되는 경우가 많습니다. 다음 필드는 한글 표기가 존재하면 반드시 한글을 우선 사용하고, 한글이 없을 때만 영문을 사용하세요.
   - name / last_name / first_name (예: "Gil-dong Hong"과 "홍길동"이 함께 있으면 last_name="홍", first_name="길동", name="홍길동")
   - company (예: "ACOUSTIC ENG"과 "어쿠스틱이엔지"가 함께 있으면 "어쿠스틱이엔지")
   - department (예: "R&D Team"과 "연구개발팀"이 함께 있으면 "연구개발팀")
   - title (예: "General Manager"와 "부장"이 함께 있으면 "부장")
